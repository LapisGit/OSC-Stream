# OSC-Stream
An Open-Source **ALWAYS FREE** Streaming Service tailored towards the OSC

## Why?
There has recently been a project that popped up called "Object Stream Community" and has recently been gaining popularity in their video where they have a call for donations.
...
There isn't really a site yet, as I don't do web design and I'd rather not pull an Object Stream Community and use AI for literally everything xD

Feel free to contribute, as there are more features I'd like to add, but currently the base features of the server are working, that includes:

- Accounts
- Shows/Episodes storing
- Server Config
- Storing YT URL's
- Auto generating URL for grabbing YouTube thumbnails

It's just an ASP.NET server using PostgreSQL.
